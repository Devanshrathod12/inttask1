...
const FormComponent = ({ postdata }) => {
  ...
  return (
    <> 
    <div className="p-4">
  <h2 className="text-center text-2xl mt-8 font-bold mb-4 text-purple-600">User Details</h2>
  <form 
  ...
  >
    <div className="mb-4">
      ...
      <input
        className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm font-extrabold focus:outline-none focus:border-blue-500"
        type="text"
