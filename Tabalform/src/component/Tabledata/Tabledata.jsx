                ...
                >
                  ...
                  <td className="p-2 flex flex-wrap justify-center space-x-1">
                    <div className="flex space-x-2 mt-2">
                      <button
                        className="px-4 py-1 bg-green-600 text-white rounded-md text-xs md:text-sm"
                        onClick={() => handleViewOpen(userdata)}
                      >
                        View
                      </button>
                      <button
                        className="px-4 py-1 bg-blue-600 text-white rounded-md text-xs md:text-sm"
                        onClick={() => handleUpdate(userdata._id)}
                      >
                        Update
                      </button>
                      <button
                        className="px-4 py-1 bg-red-600 text-white rounded-md text-xs md:text-sm"
